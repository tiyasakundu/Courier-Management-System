...
<body bgcolor="#E0E0E0">
    <h5><a href="../index.php" style="float: right; margin-right:50px; color:#6D6D6D">BackToHome</a></h5><br>
    <h1 align='center' style="color: #6D6D6D;font-size:60px">Admin Login</h1>
    <h6 align='center' style="color: #212121;font-weight: bold;font-size:15px">Welcome to our services!</h6>
